...
class User {
  ...
  bool isAddedExercise(Exercise exercise) {
    bool isAdded = false;
  ...
  bool isFavExercise(Exercise exercise) {
    bool isFav = false;
    for (var ex in favExerciseList) {
  ...
  bool isFavEquipment(Equipment equipment) {
    bool isFav = false;
    for (var eq in favEquipmentList) {
  ...
  bool isAddedEquipment(Equipment equipment) {
    bool isAdd = false;
    for (var eq in favEquipmentList) {
      if (eq.id == equipment.id) {
        isAdd = true;
